...
// ── CalendarView ──────────────────────────────────────────────────────
function CalendarView({ columns, meetings, groups }: {
  columns: Column[];
  meetings: MeetingSeries[];
  groups: Group[];
}) {
...
function Sidebar({ view, setView, projects, activeProjectId, setActiveProjectId, onAddProject, onDeleteProject, onManageGroups, onLogout, currentUser, activeProject, currentProjectRole }: {
  view: "kanban" | "gantt" | "dashboard" | "meetings" | "risks" | "weekly" | "admin" | "project_members" | "activities" | "calendar";
  setView: (v: "kanban" | "gantt" | "dashboard" | "meetings" | "risks" | "weekly" | "admin" | "project_members" | "activities" | "calendar") => void;
  projects: Project[];
...
export default function App() {
  ...
  const [view, setView] = useState<"kanban" | "gantt" | "dashboard" | "meetings" | "risks" | "weekly" | "admin" | "project_members" | "activities" | "calendar">("kanban");
  ...
  return (
    <>
      ...
      <div style={{ marginLeft: 200, display: (view === "admin" || view === "project_members" || view === "activities" || view === "calendar") ? "none" : undefined }}>
        <div className="app">
